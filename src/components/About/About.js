...
//               <h2 className="text-3xl font-semibold text-slate-800 mb-6 text-center">Professional Summary</h2>
...
//         <div className="container mx-auto px-6">
//           <h2 className="text-4xl font-light text-slate-800 text-center mb-12" data-aos="fade-up">
//             Professional <span className="font-semibold text-blue-700">Highlights</span>
//           </h2>
...
//                   <h3 className="text-2xl font-semibold text-slate-800 mb-6">Core Expertise</h3>
...
//                 <div className="bg-white rounded-lg shadow-lg p-8">
//                   <h3 className="text-2xl font-semibold text-slate-800 mb-6">Research Areas</h3>
//                   <div className="space-y-3">
...
//                   <h3 className="text-2xl font-semibold text-slate-800 mb-6">Vision</h3>
//                   <div className="space-y-4 text-slate-600">
//                     <div className="flex items-start">
//                       <div className="w-2 h-2 bg-blue-700 rounded-full mr-3 mt-2"></div>
//                       <p>Lead transformative changes in higher education through academic innovation and excellence</p>
//                     </div>
//                     <div className="flex items-start">
//                       <div className="w-2 h-2 bg-blue-700 rounded-full mr-3 mt-2"></div>
//                       <p>Foster a student-centric learning environment promoting critical thinking and lifelong learning</p>
//                     </div>
//                     <div className="flex items-start">
//                       <div className="w-2 h-2 bg-blue-700 rounded-full mr-3 mt-2"></div>
//                       <p>Bridge the gap between academia and industry through interdisciplinary research</p>
//                     </div>
//                     <div className="flex items-start">
//                       <div className="w-2 h-2 bg-blue-700 rounded-full mr-3 mt-2"></div>
//                       <p>Position institutions as centers of excellence at national and global levels</p>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//                 <div className="bg-gradient-to-br from-slate-50 to-gray-50 rounded-lg p-8">
//                   <h3 className="text-2xl font-semibold text-slate-800 mb-6">Objectives</h3>
//                   <div className="space-y-4 text-slate-600">
//                     <div className="flex items-start">
//                       <div className="w-2 h-2 bg-blue-700 rounded-full mr-3 mt-2"></div>
//                       <p>Apply 25+ years of experience toward enhancing institutional effectiveness</p>
//                     </div>
//                     <div className="flex items-start">
//                       <div className="w-2 h-2 bg-blue-700 rounded-full mr-3 mt-2"></div>
//                       <p>Promote research-driven teaching methodologies aligned with industry needs</p>
//                     </div>
//                     <div className="flex items-start">
//                       <div className="w-2 h-2 bg-blue-700 rounded-full mr-3 mt-2"></div>
//                       <p>Mentor faculty and students in achieving professional growth</p>
//                     </div>
//                     <div className="flex items-start">
//                       <div className="w-2 h-2 bg-blue-700 rounded-full mr-3 mt-2"></div>
//                       <p>Strengthen partnerships between educational institutions and industry</p>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//             <div className="bg-white rounded-lg shadow-lg p-8">
//               <h3 className="text-2xl font-semibold text-slate-800 mb-6">Professional Philosophy</h3>
